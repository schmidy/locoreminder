...
angular.module('locoReminder', ['locoReminder.filters', 'locoReminder.services', 'locoReminder.directives', 'locoReminder.controllers']).
    config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/reminder-list',       {templateUrl: 'assets/partials/reminder-list.html',     controller: 'ReminderListController'});
        $routeProvider.when('/reminder-detail/:id', {templateUrl: 'assets/partials/reminder-detail.html',   controller: 'ReminderDetailController'});
        $routeProvider.when('/reminder-creation',   {templateUrl: 'assets/partials/reminder-creation.html', controller: 'ReminderCreationController'});
        $routeProvider.when('/account-list',       {templateUrl: 'assets/partials/account-list.html',       controller: 'AccountListController'});
        $routeProvider.when('/account-detail/:id', {templateUrl: 'assets/partials/account-detail.html',     controller: 'AccountDetailController'});
        $routeProvider.when('/account-creation',    {templateUrl: 'assets/partials/account-creation.html',  controller: 'AccountCreationController'});
        $routeProvider.otherwise({redirectTo: '/reminder-list'});
    }]);
